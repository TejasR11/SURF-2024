...
class upGenerator:
    ...
    def generate_dataset(self):
        ...
        for _ in range(self.num_images):
            ...
            shape1_x = np.random.randint(0, self.image_size[0] - shape1_size[0])
            shape1_y = np.random.randint(self.image_size[1] // 3, self.image_size[1] - shape1_size[1])
            ...
            shape2_x = np.random.randint(0, self.image_size[0] - shape2_size[0])
            shape2_y = np.random.randint(self.image_size[1] // 3, self.image_size[1] - shape2_size[1])
