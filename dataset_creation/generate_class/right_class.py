...
class rightGenerator:
    ...
    def generate_dataset(self):
        ...
        for _ in range(self.num_images):
            ...
            shape1_x = np.random.randint(0, int(self.image_size[0] * 2 / 3 - shape1_size[0]))
            ...
            shape2_x = np.random.randint(0, int(self.image_size[0] * 2 / 3 - shape2_size[0]))
            ...
            if shape1_x < shape2_x:
                # Move shape 1 to the right of shape 2
                new_shape1_x = shape2_x + shape2_size[0] + random.randint(0, 500 - shape2_x)
                ...
                # Move shape 2 to the right of shape 1
                new_shape2_x = shape1_x + shape1_size[0] + random.randint(0, 500 - shape1_x)
                new_shape2_y = shape2_y
                shape2_coords_moved = [new_shape2_x, new_shape2_y, new_shape2_x + shape2_size[0], new_shape2_y + shape2_size[1]]
    ...
    def save_dataset(self, dataset):
         # Counter to distinguish different labels
        label_counter = 1001
        ...
        for label, image_pairs in dataset.items():
            ...
            for i, (img1, img2) in enumerate(image_pairs):
                # Save images in the label subdirectory
            ...
            # Save the label as a JSON file
            label_json = {"edit": label}
